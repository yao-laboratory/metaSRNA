...
./main.sh -p produce_final_form -c $output_folder/integrate/prediction_input.fasta --mi $output_folder/map_mirna/blastn_hairpin_sequences.csv --mg $output_folder/map_genome/blast_score_filter.txt -f $fna_folder/${gcf_number}.fna --inf $output_folder/integrate/redundant_sequences_information.csv --mr $output_folder/predict_mirdeep --lf $output_folder/predict_linearfold/hairpin_information.csv -o $output_folder/produce_final_form
